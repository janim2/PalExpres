...
try {
	$con /*just a variable to hold the connection and use in all pages*/ = new PDO('mysql:host=localhost; dbname='/database name here/', '/username here/'/*username*/, '/passsword here/'/*password*/);
