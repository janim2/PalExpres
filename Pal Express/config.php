...
try {
	$con /*just a variable to hold the connection and use in all pages*/ = new PDO('mysql:host=localhost; dbname=id2958837_turnup', 'id2958837_turnup'/*username*/, 'Turnup'/*password*/);
